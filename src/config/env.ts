...
const envSchema = z.object({
  ...
  PLANNING_PROMPT_CONTEXT_PLAN_CHAR_BUDGET: z.coerce.number().int().positive().default(3800),
  PLANNING_PROMPT_CONTEXT_DRAFT_CHAR_BUDGET: z.coerce.number().int().positive().default(4400),
  PLANNING_PROMPT_CONTEXT_REVIEW_CHAR_BUDGET: z.coerce.number().int().positive().default(3200),
  PLANNING_PROMPT_CONTEXT_REPAIR_CHAR_BUDGET: z.coerce.number().int().positive().default(4000),
  PLANNING_PROMPT_CONTEXT_APPROVE_CHAR_BUDGET: z.coerce.number().int().positive().default(3400),
  PLANNING_PROMPT_CONTEXT_APPROVE_DIFF_CHAR_BUDGET: z.coerce.number().int().positive().default(2600),
