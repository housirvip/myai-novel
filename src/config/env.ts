...
const envSchema = z.object({
  ...
  PLANNING_RETRIEVAL_EMBEDDING_LIMIT_BASIC: z.coerce.number().int().positive().default(10),
  PLANNING_RETRIEVAL_EMBEDDING_LIMIT_HYBRID: z.coerce.number().int().positive().default(12),
