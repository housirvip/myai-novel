...
export const __reviewServiceTestables = {
  ...
  mergeItemIssues,
  mergeMemoryIssues,
  mergeThreadFocusIssues,
  mergePressureHookIssues,
  mergeEndingReadinessIssues,
  mergeEnsembleBalanceIssues,
  mergeDebtCarryIssues,
  mergeSceneExecutionIssues,
  mergeEndingDriveIssues,
  mergeEmotionalProgressionIssues,
  deriveApprovalRisk,
  buildProtectedFactHints,
